...
PROJECTS := mytinyrenderer raylib

.PHONY: all clean help $(PROJECTS) 

all: $(PROJECTS)

mytinyrenderer: raylib
ifneq (,$(mytinyrenderer_config))
	@echo "==== Building mytinyrenderer ($(mytinyrenderer_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f mytinyrenderer.make config=$(mytinyrenderer_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f mytinyrenderer.make clean
